...
//Our Supplies Model
var supplies = require('./app/assets/data/supplies.js');

//Our Philanthropist Controller
var PhilanthropistRoute = require('./app/assets/data/philanthropists-controller.js');
var TransactionRoute = require('./app/assets/data/transactions-controller.js');
 ...
 **/
app.get('/app/assets/data/initial-supplies', function(req, res) {
 ...
 **/
app.get('/app/assets/data/product/costs', function(req, res) {
 ...
 **/
app.get('/app/assets/data/sales', function(req, res) {
